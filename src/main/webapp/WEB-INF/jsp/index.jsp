  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container-fluid px-lg-5">
	      <a class="navbar-brand" href="index">Hope</a>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-volunteer">
    	<div class="container-fluid px-md-0">
    		<div class="row no-gutters">
    			<div class="col-md-6 img-volunteer" style="background-image: url(assets/images/about.jpg);">
    				<div class="row no-gutters justify-content-end">
    					<div class="col-lg-7">
    						<div class="text py-5 pl-md-4 pr-md-3">
    							<h2 class="mb-4">Hope Charity</h2>
    							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics</p>
    							<p><a href="join" class="btn btn-primary py-3 px-4">Join now</a></p>
    						</div>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-6 d-flex align-items-center bg-primary">
    				<div class="about-text px-3 py-5 pl-md-5 pr-md-5">
    					...
    					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics</p>
    					<p><a href="payment" class="btn btn-black py-3 px-4">Donate now</a></p>
    				</div>
    			</div>
    		</div>
    	</div>
    ...
    <section class="services-section py-5 py-md-0">
      <div class="container">
        			...
        			<div class="progress" style="height:50px">
							...
							<div class="text mt-4 d-md-flex">
								...
								<div class="one text-md-right">
									<p><a href="Payment.html" class="btn btn-primary">Donate now</a></p>
								</div>
							</div>
        		</div>
        	</div>
		...
		<section class="ftco-section ftco-vol img" style="background-image: url('assets/images/bg_3.jpg');">
			<div class="overlay"></div>
			<div class="container">
    ...
    <section class="ftco-section ftco-causes">
        ...
        <div class="row">
        	<div class="col-md-4">
        		<div class="causes causes-2 text-center ftco-animate">
        			<div class="img" style="background-image: url(assets/images/causes-1.jpg);"></div>
        	...
        	<div class="col-md-4">
        		<div class="causes causes-2 text-center ftco-animate">
        			<div class="img" style="background-image: url(assets/images/causes-2.jpg);"></div>
        	...
        	<div class="col-md-4">
        		<div class="causes causes-2 text-center ftco-animate">
        			<div class="img" style="background-image: url(assets/images/causes-3.jpg);"></div>
        ...
        <div class="row intro mt-5 pt-md-4">
        	<div class="col-md-4 ftco-animate">
        		...
        		<p class="mt-2"><a href="Payment.html" class="btn btn-primary">Start Donation</a></p>
        	</div>
    ...
    <section class="ftco-counter ftco-section img" id="section-counter" style="background-image: url(assets/images/bg_2.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	...
        	<div class="col-md-6">
              ...
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('assets/images/image_2.jpg');">
              </a>
            ...
            <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('assets/images/image_3.jpg');">
              </a>
              <div class="text text-thumb d-block pl-2 pl-md-4">
            ...
            <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('assets/images/image_4.jpg');">
              </a>
              <div class="text text-thumb d-block pl-2 pl-md-4">
    ...
    <footer class="ftco-footer ftco-section img" style="background-image: url(assets/images/footer.jpg);">
    	<div class="overlay"></div>
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Hope</h2>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
