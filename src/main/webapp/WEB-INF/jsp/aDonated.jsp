    ...
    <aside class="left-panel" tabindex="5003" style="overflow: hidden; outline: none;">
        ...
        <nav class="navigation">
            <ul class="list-unstyled">
                <li class="has-submenu"><a href="Admin"><i class="fa fa-heart-o"></i> <span
                ...
                <li class="active"><a href="aDonated"><i class="fa fa-heart-o"></i> <span class="nav-label">Donated Items</span></a>
                </li>
                  ...
                  <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach items="${req}" var="p" >
                                        ...
                                        <tr class="success">
                                           <td><%=i %></td>
                                            <td>${p.getId_donator().getUid().getName()}</td>
