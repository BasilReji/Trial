...
<body>
    <aside class="left-panel" tabindex="5003" style="overflow: hidden; outline: none;">
        ...
        <nav class="navigation">
            <ul class="list-unstyled">
                <li class="active"><a href="Admin"><i class="fa fa-heart-o"></i> <span
                            class="nav-label">Users</span></a>
                </li> 
                <li class="has-submenu"><a href="aRequested"><i class="fa fa-bookmark-o"></i><span class="nav-label">
                            Requested 
                            Items</span></a>
                </li>
                <li class="has-submenu"><a href="aDonated"><i class="fa fa-heart-o"></i> <span class="nav-label">Donated Items</span></a>
                </li>
    ...
    <section class="content">
          ...
          <div class="box">
            <h2 style="text-align: center;">Hope Users</h2>
            <div class="container">
                <div class="row">
                    <br><br><br>
                <div id="app">
                                    ...
                                    <c:forEach items="${us}" var="p" >
                                        ...
                                        <tr class="success">
                                           <td><%=i %></td>
                                            ...
                                            <input type="hidden" name="pid" value="${p.getUid()}">
