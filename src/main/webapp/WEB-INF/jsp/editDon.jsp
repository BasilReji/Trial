    ...
    <aside class="left-panel" tabindex="5003" style="overflow: hidden; outline: none;">
        ...
        <nav class="navigation">
            <ul class="list-unstyled">
               <li class="has-submenu"><a href="Donator"><i class="fa fa-heart-o"></i> <span
                ...
                <li class="active"><a href="Donatedi"><i class="fa fa-heart-o"></i> <span class="nav-label">Donated Items</span></a>
                </li>
                ...
                <div id="app">
                 <div  class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                  ...
                  <div class="table-responsive">
                               <form:form class="row register-form" action="editDona" method="post">
                               
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Product Name *" value="${req.getId_Product().getPname()}"
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Category *" value="${req.getId_Product().getCateg()}"
                                        name="categ"  required />
                                </div>
                                <div class="form-group">
                                	 <input type="text" class="form-control" placeholder="Status *" value="${req.getStatus()}"
                                        name="Status" id="password" required />
                                   
                                </div>
                                <input type="hidden" name="did" value="${req.getDid()}">
