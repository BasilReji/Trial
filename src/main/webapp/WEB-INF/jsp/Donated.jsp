...
<body>
    ...
    <section class="content">
          ...
          <div class="box">
            <h2 style="text-align: center;">Donated Items</h2>
            <div class="container">
                <div class="row">
                    <br><br><br>
                <div id="app">
                  ...
                  <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach items="${req}" var="p" >
                                        ...
                                        <tr class="success">
                                           <td><%=i %></td>
                                            <td>${p.getId_Product().getPname()}</td>
                                              <td>${p.getQuant()}</td>
                                              <td>${p.getStatus()}</td>
                                              
                                              
                                            <td>${p.getId_Product().getOid().getUid().getName()}</td> 
                                            <form action="editDon">
                                            <td>
                                            
                                            <input type="hidden" name="did" value="${p.getDid()}">
