...
<body>
    <aside class="left-panel" tabindex="5003" style="overflow: hidden; outline: none;">
        ...
        <nav class="navigation">
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="Request"><i class="fa fa-heart-o"></i> <span class="nav-label">Request Items</span></a>
                </li>
    ...
    <section class="content">
          ...
          <div class="box">
            <h2 style="text-align: center;">Request Here</h2>
            <div class="container">
                <div class="row">
                    <br><br><br>
                <div id="app">
			...
			<div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Wanted Quantity *" value=""
                                        name="quant" id="quant" required />
                                </div>
                                
                                <div class="form-group">
                                    <textarea rows="5" cols="35" placeholder="Description *" name="desc" ></textarea>
                                </div>
